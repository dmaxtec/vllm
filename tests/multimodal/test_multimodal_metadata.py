...
from .test_model.model import TestModel, TextConditioningPlugin
from .test_model.config import TestModelConfig


ModelRegistry.register_model("TestModel", TestModel)
...
def test_multimodal_metadata():
    ...
    assert step2_out[0].outputs[0].token_ids[1] == 19
